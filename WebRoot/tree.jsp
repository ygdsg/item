...
var treeMenu = [
	{ level:1, name:"部门管理"},
	{ level:2, name:"新增部门", ico:"images/icon_default.gif",link:"depts/Depts_add.jsp"},
	{ level:2, name:"部门列表", ico:"images/icon_default.gif",link:"dept/deptList"},
	{ level:1, name:"员工管理"},
	{ level:2, name:"新增员工", ico:"images/icon_default.gif",link:"emp/getDept"},
	{ level:2, name:"员工列表", ico:"images/icon_default.gif",link:"emp/empList"}
];
</script>
<style>
* {
