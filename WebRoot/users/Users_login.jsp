...
#image
{
	...
	left:15%;
	top:12%;
	background-image:url("/ssm_hr/images/admin.png");
}
#mainPanel #right{
	float:left;
	position:relative;
...
<div id="wrapper">
			...
			<div id="mainPanel">
				...
				<div id="right">
					...
					<div id="user-password">
						...
						<span class="input"><input type="password" name="userpwd" class="form-input"></span>
					</div>
					<div id="button-group">
						<input type="submit" class="btn" value="登录"/>
						<input type="reset" class="btn" value="重置"/>
					</div><p style="height:2px;"></p>
					<div>
					  <!-- 此处显示表单验证的出错信息 -->
					  <center><font style="color:red;font-size:14px;">${msg}</font></center>
					</div>
					</form>
	...
	<div id="footer">
		<div id="text">Copyright © 2009-2019 All Rights Reserved Powered By Mr Dandan</div>
	</div>
</div>
</body>
</html>